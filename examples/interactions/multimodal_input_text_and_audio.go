...
func main() {
	...
	candidatePaths := []string{
		"testdata/voice_sample.wav",
		"../testdata/voice_sample.wav",
		"../../testdata/voice_sample.wav",
		"third_party/golang/google_golang_org/genai/v/v0/google/genai/testdata/voice_sample.wav",
	}
	var audioBytes []byte
	for _, p := range candidatePaths {
		audioBytes, err = os.ReadFile(p)
		if err == nil {
			break
		}
	}
	if err != nil {
		log.Fatal("Failed to read voice_sample.wav from any candidate path. Last error:", err)
	}
