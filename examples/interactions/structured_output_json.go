...
func main() {
	...
	textFormat := gaos_interactions.TextResponseFormat{
		MimeType: gaos_interactions.TextResponseFormatMimeTypeApplicationJSON.ToPointer(),
		Schema:   format,
	}
	responseFormat := gaos_interactions.NewResponseFormat(textFormat)
	createModelInteractionResponseFormat := gaos_interactions.NewCreateModelInteractionResponseFormat(responseFormat)
