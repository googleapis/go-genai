...
func tuningValidationDatasetToMldev(fromObject map[string]any, parentObject map[string]any) (toObject map[string]any, err error) {
	toObject = make(map[string]any)
	if getValueByPath(fromObject, []string{"gcsUri"}) != nil {
		return nil, fmt.Errorf("gcsUri parameter is not supported in Gemini API")
	}
...
func tuningExampleToVertex(fromObject map[string]any, parentObject map[string]any) (toObject map[string]any, err error) {
	toObject = make(map[string]any)
	if getValueByPath(fromObject, []string{"textInput"}) != nil {
		return nil, fmt.Errorf("textInput parameter is not supported in Vertex AI")
	}

	if getValueByPath(fromObject, []string{"output"}) != nil {
		return nil, fmt.Errorf("output parameter is not supported in Vertex AI")
	}
...
func tunedModelCheckpointFromMldev(fromObject map[string]any, parentObject map[string]any) (toObject map[string]any, err error) {
	toObject = make(map[string]any)
...
func operationFromMldev(fromObject map[string]any, parentObject map[string]any) (toObject map[string]any, err error) {
	toObject = make(map[string]any)
...
func (m Tunings) tuneMldev(ctx context.Context, baseModel string, trainingDataset *TuningDataset, config *CreateTuningJobConfig) (*Operation, error) {
	parameterMap := make(map[string]any)
	...
	if m.apiClient.clientConfig.Backend == BackendVertexAI {
		...
		fromConverter = operationFromMldev
	}
