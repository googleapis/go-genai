...
// RequestOption is an option for the requests made by the gemini-next-gen-api API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/google.golang.org/genai/interactions#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://generativelanguage.googleapis.com/")
}
...
func WithAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.APIKey = value
		return r.Apply(WithHeader("x-goog-api-key", r.APIKey))
	})
}

// WithAPIVersion returns a RequestOption that sets the client setting "api_version".
