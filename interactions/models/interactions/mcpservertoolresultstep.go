...
type MCPServerToolResultStepResultUnionMember interface {
	[]FunctionResultSubcontent | MCPServerToolResultStepResult | string
}

func NewMCPServerToolResultStepResultUnion[T MCPServerToolResultStepResultUnionMember](val T) MCPServerToolResultStepResultUnion {
	...
	case MCPServerToolResultStepResult:
		return MCPServerToolResultStepResultUnion{
			MCPServerToolResultStepResult: &v,
	...
	panic(fmt.Sprintf("unreachable: %T is not a member of union MCPServerToolResultStepResultUnion", val))
}
func NewMCPServerToolResultStepResultUnionUnknown(raw json.RawMessage) MCPServerToolResultStepResultUnion {
	return MCPServerToolResultStepResultUnion{
		UnknownRaw: raw,
