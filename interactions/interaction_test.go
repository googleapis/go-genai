...
func TestInteractionNewAgentWithOptionalParams(t *testing.T) {
	...
	_, err := client.Interactions.NewAgent(context.TODO(), interactions.NewAgentParams{
		...
		ResponseFormat: &interactions.NewAgentParamsResponseFormat{
			ResponseFormatListArray: interactions.ResponseFormatList{interactions.ResponseFormatListItem{
				AudioResponseFormat: &interactions.AudioResponseFormat{
					BitRate:    new(0),
					Delivery:   "inline",
					MimeType:   "audio/mp3",
					SampleRate: new(0),
...
func TestInteractionNewModelWithOptionalParams(t *testing.T) {
	...
	_, err := client.Interactions.NewModel(context.TODO(), interactions.NewModelParams{
		...
		PreviousInteractionID: "previous_interaction_id",
		ResponseFormat: &interactions.NewModelParamsResponseFormat{
			ResponseFormatListArray: interactions.ResponseFormatList{interactions.ResponseFormatListItem{
				AudioResponseFormat: &interactions.AudioResponseFormat{
					BitRate:    new(0),
					Delivery:   "inline",
