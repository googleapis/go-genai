...
// Package main provides an example of using Private Inference in the Go GenAI SDK.
package main
...
func main() {
	...
	log.Println("Sending basic private inference request...")
	resp, err := client.Models.GenerateContent(ctx, model, genai.Text("Why is the sky blue?"), nil)
	if err != nil {
